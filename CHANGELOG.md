...
## کارکنان و پنل‌های اختصاصی (۳ مهر ۱۴۰۵) — جزئیات: docs/06-STAFF-PANELS.md

- **مدیریت کارکنان در پنل مدیر:** افزودن، ویرایش، غیرفعال‌سازی و حذف کارکنان، همراه با اطلاعات شخصی، بخش، شیفت، دسترسی دستی و ساخت نام کاربری و رمز. مایگریشن `004_staff_accounts.sql` و API `/users/staff` اضافه شد.
- **ورود:** با ایمیل یا نام کاربری. هر کارمند فقط پنل‌های مجاز خودش را می‌بیند: میز لابی، میز مسئول مشاعات، سفارش‌ها و منوی رستوران، سفارش‌ها و منوی کافی‌شاپ، نگهبانی و تأسیسات.
- **منوی رستوران و کافی‌شاپ:** افزودن، ویرایش و حذف آیتم، عکس، قیمت اختیاری، وضعیت ناموجود یا مخفی، و «غذای روز» که برای ساکنین اعلان می‌رود.
- **رزروها:** مسئولیت تایید رزرو با «مسئول مشاعات» است و مدیر هم دسترسی دارد.
- **ساکن:** بعد از ثبت سفارش فقط پیام «سفارش شما ثبت شد» نمایش داده می‌شود و وضعیت واقعی سفارش از آشپزخانه دنبال می‌شود. تیکت با انتخاب موضوع شروع می‌شود (خرابی، انتقاد، پیشنهاد یا پیام به مدیر) و محل خرابی به‌صورت پیش‌فرض طبقه و واحد خود ساکن است.
